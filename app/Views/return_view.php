        ...
        <div class="borrow-card">
            ...
            <form id="returnForm">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="borrow-input" name="equipment" required>
                ...
                <!-- Return Date -->
                <div class="form-group mb-3">
                    <label class="borrow-label">Return Date</label>
                    <input type="date" class="borrow-input" name="return_date" value="<?= date('Y-m-d'); ?>" required>
                </div>

                <button class="borrow-btn mt-2" type="submit">Confirm Return</button>
